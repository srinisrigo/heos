...
<?php
        ...
        <td>Date Discussed :</td><td><input type=\"text\" name=\"Date1\" id=\"Date1\" value=\"\" size=\"13\"><a href=\"javascript:NewCal('Date1','ddmmmyyyy')\"><img src=\"cal.gif\" alt=\"Pick a date\" width=\"20\" height=\"20\" border=\"0\"></a></td></tr>

        <table align=\"center\" border=0 cellspacing=1 cellpadding=0><tr><br><td colspan=\"6\">
        <u><b>SECTION D-DECLARATION</b></u><br><input type=\"checkbox\" name=\"Check\" id=\"check\" onClick=\"return agree(this);\" >I believe that the above information is accurate. <i>I confirm that details of this appeal can be passed on to the Principal, Director, Trustees and other staff concerned.</i></td></tr>
