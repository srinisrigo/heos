...
if($clickedobject=="true") $onoff=mysql_query("update random set ckbx='on',accountnumber='$accountnumber',dueamount='$payamount' where sno='$sno'");
else $onoff=mysql_query("update random set ckbx='off',accountnumber='$accountnumber',dueamount='$payamount' where sno='$sno'");
...
$objResponse =& new xajaxResponse();
$con=mysql_connect('192.168.15.24','root','admin'); $db=mysql_select_db('heos');
$randomon=mysql_query("select * from random where ckbx='on'");
while($rs=mysql_fetch_array($randomon)){
$onrecordeid=$rs['recordid'];
$oninvoicenumber=$rs['invoicenumber'];
$randomcount=mysql_query("select count(invoicenumber) from random where recordid='$onrecordeid' and invoicenumber='$oninvoicenumber'");
if($randomcount>1) {
$setreadonly=mysql_query("select sno from random where recordid='$onrecordeid' and invoicenumber='$oninvoicenumber'");
...
$purchaseselect=mysql_query("select * from purchase where recordid='$randomrecordid' AND invoicenumber='$randominvoicenumber'");
...
$balanceselect=mysql_query("select * from balance where accountnumber='$randomaccountnumber'");
...
$updatebalance=mysql_query("update balance set balance='$newbalance',curdate='$sysdate',lastbalance='$prebalance',lastdate='$predate' where accountnumber='$randomaccountnumber'");
$updatebankdetails=mysql_query("update bankdetails set balance='$newbalance' where accountnumber='$randomaccountnumber'");

$purchaseduebalance=$purchaseduebalance-$randomdueamount; $purchaseduepending--;
switch($randomwhichdue){
case 1:{ $updatepurchase=mysql_query("update purchase set dueamount1='$randomdueamount',dueamount2='$nextduereplaceamount',dueamount='$purchaseduebalance',dueremaining='$purchaseduepending',due1paid='yes' where recordid='$randomrecordid' and invoicenumber='$randominvoicenumber'"); } break;
case 2:{ $updatepurchase=mysql_query("update purchase set dueamount2='$randomdueamount',dueamount3='$nextduereplaceamount',dueamount='$purchaseduebalance',dueremaining='$purchaseduepending',due2paid='yes' where recordid='$randomrecordid' and invoicenumber='$randominvoicenumber'"); } break;
case 3:{ $updatepurchase=mysql_query("update purchase set dueamount3='$randomdueamount',dueamount4='$nextduereplaceamount',dueamount='$purchaseduebalance',dueremaining='$purchaseduepending',due3paid='yes' where recordid='$randomrecordid' and invoicenumber='$randominvoicenumber'"); } break;
case 4:{ $updatepurchase=mysql_query("update purchase set dueamount4='$randomdueamount',dueamount5='$nextduereplaceamount',dueamount='$purchaseduebalance',dueremaining='$purchaseduepending',due4paid='yes' where recordid='$randomrecordid' and invoicenumber='$randominvoicenumber'"); } break;
case 5:{ $updatepurchase=mysql_query("update purchase set dueamount5='$randomdueamount',dueamount='$purchaseduebalance',dueremaining='$purchaseduepending',due5paid='yes' where recordid='$randomrecordid' and invoicenumber='$randominvoicenumber'"); } break;
}
}
}
...
{
$result=mysql_query("select bankname,branchname from bankdetails where accountnumber='$accountnumber'");
...
$exec=mysql_query("select count(*) from supplierdetails where supplierid='$id'");
if(mysql_result($exec,0)>0) { $exec=mysql_query("select suppliername from supplierdetails where supplierid='$id'"); $name=mysql_result($exec,0);
...
$exec=mysql_query("select count(*) from supplierdetails where suppliername='$id'");
if(mysql_result($exec,0)>0) { $exec=mysql_query("select supplierid from supplierdetails where suppliername='$id'"); $name=mysql_result($exec,0);
...
$exec=mysql_query("select count(*) from nominalcodes where nominalcode='$code'");
if(mysql_result($exec,0)>0) { $exec=mysql_query("select nominalname from nominalcodes where nominalcode='$code'"); $name=mysql_result($exec,0);
$objResponse->addScript("document.getElementById('$objname').value ='".$name."';"); }
}
if($st==2){
$objResponse->addScript("document.getElementById('$objname').value ='';");
$exec=mysql_query("select count(*) from nominalcodes where nominalname='$code'");
if(mysql_result($exec,0)>0) { $exec=mysql_query("select nominalcode from nominalcodes where nominalname='$code'"); $name=mysql_result($exec,0);
$objResponse->addScript("document.getElementById('$objname').value ='".$name."';"); }
}
return $objResponse->getXML();
}
...
$result=mysql_query("select DISTINCT(coursecode) from student where intake='$batchvalue'");
while($rs1=mysql_fetch_array($result)){
$code=$rs1["coursecode"];
$sel=mysql_query("select CourseName from coursedetails where coursecode='$code'"); $name=mysql_result($sel,0);
...
$objResponse->addScript("document.getElementById('studentcombo').options.length = 0;");
$objResponse->addScript("addOption('studentcombo','" . 'Select' . "','" . 'Select' . "');");
$result=mysql_query("select count(*) from student where coursecode='$coursevalue' and intake='$batchvalue'");
if(mysql_result($result,0)>0){
$result=mysql_query("select studentid from student where coursecode='$coursevalue' and intake='$batchvalue'");
...
$result=mysql_query("select agentid,feepaid from student where intake='$batchvalue' and coursecode='$coursevalue' and studentid='$studentidvalue'");
while($rs1=mysql_fetch_array($result)){
$agentid=$rs1["agentid"];
$amount=$rs1["feepaid"]; }
$countstudentidexec=mysql_query("select count(studentid) from refund where studentid='$studentidvalue'");
$count=mysql_result($countstudentidexec,0);
if($count==0){
if ($agentid!="" || $amount!=""){
$result=mysql_query("select accountnumber from balance where balance >= '$amount'");
...
$con=mysql_connect('192.168.15.24','root','admin'); $db=mysql_select_db('heos');
if($id!="Select"){
$exec=mysql_query("select * from persondetails where personid='$id'");
...
//$objResponse->addScript("alert('$accountnumber')");
if($clickedobject=="true") $onoff=mysql_query("update paythis set onoff='on' where recordid='$recordid'");
else $onoff=mysql_query("update paythis set onoff='off' where recordid='$recordid'");
...
$con=mysql_connect('192.168.15.24','root','admin'); $db=mysql_select_db('heos');
$sysdate=date('Y-m-d');
$onoff=mysql_query("select * from paythis where onoff='on'");
while($rs1=mysql_fetch_array($onoff)){
$id=$rs1['recordid'];
$oneecord=mysql_query("select * from paymentdetails where recordid='$id'");
...
$selectbalance=mysql_query("select * from balance where accountnumber='$accountnumber'");
...
$balanceup=mysql_query("update balance set total='$curtotal',balance='$curbalance',curdate='$sysdate',lastbalance='$balance',lastdate='$curdate' where accountnumber='$accountnumber'");
$pamentup=mysql_query("update paymentdetails set done='yes' where recordid='$id'");
$randomup=mysql_query($randominsert);
...
$balanceup=mysql_query("update balance set total='$curtotal' where accountnumber='$accountnumber'");
$pamentup=mysql_query("update paymentdetails set done='yes' where recordid='$id'");
$randomup=mysql_query($randominsert);
if($balanceup&&$pamentup&&$randomup) $objResponse->addScript("alert('Successfully done')");
}
...
$bank=mysql_query("select * from balance where accountnumber='$accountnumbercombo'");
...
$pur=mysql_query("select * from purchase where recordid='$recordid'");
...
if($pendingmode=="Cash"){
$balanceup=mysql_query("update balance set total='$curtotal',balance='$curbalance',lastbalance='$balance',lastdate='$curdate',curdate='$date' where accountnumber='$accountnumbercombo'");
$ranquery="insert into ".$tablename." values('0','Dr','$customername','$date','$payingamount','$curbalance')";
$rndomup=mysql_query($ranquery);
if($billamount>=$piadset) $purcahseup=mysql_query("update purchase set paidamount='$piadset',paydate='$nextpaydate' where recordid='$recordid'");
if($balanceup&&$rndomup&&$purcahseup) $objResponse->addScript("alert('Success...');");
}
else{
$balanceup=mysql_query("update balance set balance='$curbalance',lastbalance='$balance',lastdate='$curdate',curdate='$date' where accountnumber='$accountnumbercombo'");
if($billamount>=$piadset) $purcahseup=mysql_query("update purchase set paidamount='$piadset',paydate='$nextpaydate' where recordid='$recordid'");
if($pendingmode=="DD") $cdnumber=$dnumber; else $cdnumber=$cnumber;
$payment=mysql_query("insert into paymentdetails values('0','$payingamount','$accountnumbercombo','Pendings','$pendingmode','$cdnumber','$date','$dbankname','$dbranch','$ddto','no')");
...
$selectquery=mysql_query("select * from purchase where recordid='$recordid'");
...
$result=mysql_query("select accountnumber from balance where balance >= '$pound'");
$objResponse->addScript("document.getElementById('accountnumbercombo').disabled = false;");
$objResponse->addScript("document.getElementById('accountnumbercombo').options.length = 0;");
$objResponse->addScript("addOption('accountnumbercombo','" . 'Select' . "','" . 'Select' . "');");
while($rs2=mysql_fetch_array($result))
...
$rs=mysql_query("select distinct(CourseName) from coursedetails where LevelOfTheCourse='$degree'");
